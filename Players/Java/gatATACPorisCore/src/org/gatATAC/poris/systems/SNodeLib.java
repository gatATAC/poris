...
import org.gatATAC.poris.systems.MVC.Model;
import org.gatATAC.poris.systems.MVC.Observer;
        ...
        for (int i = 0; i < instanceNodes.getLength(); i++) {
            ...
            if (instanceTypeNode != null) {
                ...
                try {
                    ...
                    Class nodeClass = Class.forName("org.gatATAC.poris.systems." + instanceClassName);
                    if (nodeClass != null) {
