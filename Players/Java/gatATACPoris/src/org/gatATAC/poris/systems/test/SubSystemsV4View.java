...
import org.gatATAC.poris.systems.OPMSGUI.CfgGUI;
import org.gatATAC.poris.systems.OPMSGUI.OPMSFrame;
import org.gatATAC.poris.systems.OPMSGUI.OPMSXMLFrame;
...
public class SubSystemsV4View extends FrameView {
    ...
    OPMSXMLFrame opmsXMLFrame = new OPMSXMLFrame();
    OPMSXMLFrame opmsXMLCfgFrame = new OPMSXMLFrame();
    OPMSFrame opmsFrame = new OPMSFrame();
    ...
    private void initComponents() {
        ...
        openOPMS = new javax.swing.JButton();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.gatATAC.poris.systems.test.SubSystemsV4App.class).getContext().getResourceMap(SubSystemsV4View.class);
        openOPMS.setText(resourceMap.getString("openOPMS.text")); // NOI18N
        openOPMS.setName("openOPMS"); // NOI18N
        openOPMS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                openOPMSActionPerformed(evt);
            }
        });
            ...
            .add(buttonPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(buttonPanelLayout.createSequentialGroup()
                    ...
                    .add(buttonPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                        .add(org.jdesktop.layout.GroupLayout.LEADING, openOPMS, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(org.gatATAC.poris.systems.test.SubSystemsV4App.class).getContext().getActionMap(SubSystemsV4View.class, this);
        ...
        statusPanelLayout.setHorizontalGroup(
            ...
            .add(statusPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 723, Short.MAX_VALUE)
    ...
    private void openOPMSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openOPMSActionPerformed
        opmsFrame.setVisible(true);
}//GEN-LAST:event_openOPMSActionPerformed
    ...
    private void genCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_genCodeActionPerformed
        ...
        if (s.subTree(aux)) {
            sLib.addSNodes(aux);
            // XML output
            this.loadModelIntoResult(sLib, "Modelo de " + s, opmsXMLFrame.mainPanel, opmsXMLFrame.resultPanel, 1);
            c = new Cfg((SubSystem) s);
            aux.clear();
            if (c.subTree(aux)) {
                cLib.addSNodes(aux);
                this.loadModelIntoResult(cLib, "Configuracion de " + c, opmsXMLCfgFrame.mainPanel, opmsXMLCfgFrame.resultPanel, 1);
                loadCfgIntoGUI((Cfg) c, "Configuración de " + c, opmsFrame.mainPanel, opmsFrame.resultPanel);
            }
        }
    ...
    private javax.swing.JButton openOPMS;
