...
function RunPlayer() {
  ...
  if (location.href.substr(0, 5) != "file:") {
    url = "http://www.yworks.com/products/graphmlviewer/1.0.1/GraphMLViewer.swf";
  }
  ...
  var str = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" ' +
            ...
            '  width="' + params["width"] + '" height="' + params["height"] + '" name="GraphMLViewer" align="middle"' +
            '  play="true"' +
            '  loop="false"' +
...
function InstallFlashUpdate() {
  ...
  if (hasProductInstall) {
    ...
    document.write('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" ' +
                   'id="yEdViewer.graphml" width="' + params["width"] + '" height="' + params["height"] + '"' +
                   ' codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab">' +
                   ' <param name="movie" value="http://www.yworks.com/products/graphmlviewer/1.0/playerProductInstall.swf" />' +
                   ' <param name="quality" value="high" />' +
                   ' <param name="bgcolor" value="#ffffff" />' +
                   ' <param name="allowScriptAccess" value="sameDomain" />' +
                   ' <param name="FlashVars" value="' + fv + '" />' +
                   ' <embed src="http://www.yworks.com/products/graphmlviewer/1.0/playerProductInstall.swf" quality="high" bgcolor="#ffffff"' +
